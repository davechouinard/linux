...
sudo apt-get update
sudo apt-get -y install vim xfonts-terminus fonts-inconsolata xfce4-clipman git i3-wm i3status suckless-tools terminator rxvt-unicode-256color screenfetch
sudo fc-cache -fv
